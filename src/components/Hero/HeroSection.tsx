      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <div className="animate-fade-up">
          ...
          <div className="mb-8">
            ...
            <h1 className="hero-text text-white text-shadow-lg mb-2 text-7xl py-[23px]">M I N É A</h1>
          ...
          animationDelay: '0.6s'
            ...
            <Button asChild size="lg" className="bg-cream-500 hover:bg-cream-600 text-gray-900 font-medium border-2 border-cream-500 hover:border-cream-600 transition-all duration-300">
              <Link to="/projects" className="flex items-center gap-2">
                צפה בפרויקטים
                <ArrowLeft size={18} className="rotate-180" />
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="border-2 border-white text-white hover:bg-white hover:text-gray-900 font-medium transition-all duration-300 bg-white/10 backdrop-blur-sm">
