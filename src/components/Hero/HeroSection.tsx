      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <div className="animate-fade-up">
          ...
          <div className="mb-8">
            ...
            <h1 className="hero-text text-white text-shadow-lg mb-2 text-base">N M A E I</h1>
          ...
          animationDelay: '0.6s'
            ...
            <Button asChild size="lg" className="bg-cream-500 hover:bg-cream-600 text-gray-900 font-medium">
