  ...
  if (loading) {
    return (
      <div className="text-center p-10">
        {/* <img src={loading_icon} alt="Loading" style={{ margin: 'auto' }} /> */}
      </div>
    );
  }
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-gold-600 text-gold-600 hover:bg-gold-600 hover:text-black"
            >
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-3xl mx-auto animate-fade-up">
              ...
              <p className="body-large text-gray-600 mb-8">{content.cta.description}</p>
