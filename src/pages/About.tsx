            ...
            <div className="space-y-6 animate-fade-up">
              <div>
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>נעים מאוד,
אני נופר אדריכלית ומעצבת פנים </p>
...
כל פרויקט מתחיל בהקשבה עמוקה ובחיבור אינטואיטיבי ללקוח. עבורי, הלקוח הוא לא משימה לסיום, אלא סיפור שלם שכולל תובנות, רגשות ומשמעות.
                  ...
                  <p>מתוך ההקשבה נולדת היצירה. אני מתרגמת רגשות, זיכרונות ואנרגיה לתכנון אישי, מדויק ושלם. כמו מערכת חכמה שמעבדת נתונים והופכת אותם לממצאים– כך אני יוצרת חללים שמספרים את הסיפור הפנימי של מי שיחיה בהם.</p>
                </div>
              </div>
